...
Meu nome é Renan Belem Biavati. Sou um profissional em transição de carreira, focado em **Ciência da Computação** com ênfase em **Inteligência Artificial Aplicada** e **Aprendizado de Máquina**. Este repositório reflete meus projetos acadêmicos e experiências práticas em desenvolvimento de software.
...
* **Atividades Chave:**
    * Gestão de ferramentas de sustentação e *backlog*.
    * Desenvolvimento *front-end* e *web analytics*.
    * Participação no projeto de criação de **assistente virtual inteligente com IA generativa** para *e-commerce*.
    * Gestão de fornecedores e manipulação de dados em Excel.

### Fractal - Empresa Júnior de Tecnologia da PUCPR
* **Cargo:** Trabalho Voluntário e Criação da Empresa 
* **Período:** Julho/2022 – Junho/2023 
* **Foco:** Gestão de pessoas e documentos, uso de método ágil e organização de projetos.
...
* **Português:** Domínio Pleno (C2)
* **Inglês:** Intermediário (B2)
* **Chinês:** Iniciante (HSK2)
